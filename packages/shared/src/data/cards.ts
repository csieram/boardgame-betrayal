...
export const OMEN_CARDS: Card[] = [
  ...
  },
  {
    ...
    icon: `<rect x="20" y="20" width="60" height="60" fill="#4A4A4A"/>
           <path d="M35 30 L65 30 L60 70 L40 70 Z" fill="#6B6B5B" stroke="#8B8B7B" stroke-width="2"/>
           <rect x="42" y="35" width="16" height="20" fill="#5B5B4B"/>
           <line x1="35" y1="40" x2="30" y2="50" stroke="#7B7B6B" stroke-width="3"/>
           <line x1="65" y1="40" x2="70" y2="50" stroke="#7B7B6B" stroke-width="3"/>
           <circle cx="50" cy="45" r="5" fill="#4A4A3A"/>`,
  ...
  },
  {
    ...
    icon: `<rect x="20" y="20" width="60" height="60" fill="#2A1A0A"/>
           <ellipse cx="50" cy="50" rx="20" ry="22" fill="none" stroke="#FFD700" stroke-width="4"/>
           <path d="M50 28 Q70 35 65 50 Q60 65 50 72" stroke="#B8860B" stroke-width="2" fill="none"/>
           <circle cx="50" cy="50" r="6" fill="#8B0000"/>
           <path d="M47 47 L53 53 M53 47 L47 53" stroke="#FFD700" stroke-width="1"/>`,
  ...
  },
  {
    ...
    icon: `<rect x="20" y="20" width="60" height="60" fill="#4A3A2A"/>
           <ellipse cx="50" cy="55" rx="18" ry="12" fill="#8B6914"/>
           <ellipse cx="38" cy="48" rx="10" ry="12" fill="#8B6914"/>
           <ellipse cx="35" cy="42" rx="4" ry="6" fill="#6B4914"/>
           <circle cx="36" cy="45" r="2" fill="#000"/>
           <ellipse cx="42" cy="52" rx="2" ry="1" fill="#000"/>
           <ellipse cx="50" cy="62" rx="3" ry="8" fill="#8B6914"/>
           <ellipse cx="45" cy="65" rx="2" ry="6" fill="#8B6914"/>
           <ellipse cx="55" cy="65" rx="2" ry="6" fill="#8B6914"/>`,
  ...
  },
  {
    ...
    icon: `<rect x="25" y="25" width="40" height="45" fill="#8B4513"/>
           <rect x="28" y="28" width="34" height="39" fill="#F5DEB3"/>
           <path d="M32 38 Q40 35 48 38 Q45 42 38 40" stroke="#4B0082" stroke-width="1" fill="none"/>
           <path d="M35 45 Q42 42 50 45 Q47 50 40 48" stroke="#8B0000" stroke-width="1" fill="none"/>
           <path d="M38 52 Q45 50 52 53" stroke="#006400" stroke-width="1" fill="none"/>
           <circle cx="42" cy="58" r="3" fill="none" stroke="#333" stroke-width="1"/>
           <text x="40" y="61" font-size="4" fill="#333">?</text>`,
