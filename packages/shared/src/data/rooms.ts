...
export const BASEMENT_ROOMS: Room[] = [
  ...
  { id: 'crypt', name: '墓穴', nameEn: 'Crypt', floor: 'basement', symbol: 'I', doors: ['north'], description: '存放石棺的墓穴', color: '#3A3A4A', icon: `${floor('#4A4A5A')}${doorN}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/18-crypt.svg' },
  { id: 'dungeon', name: '地牢', nameEn: 'Dungeon', floor: 'basement', symbol: null, doors: ['north'], description: '陰森的地牢', color: '#2A2A3A', icon: `${floor('#3A3A4A')}${doorN}`, isOfficial: true, gallerySvg: '/gallery/rooms/19-dungeon.svg' },
  { id: 'furnace_room', name: '鍋爐房', nameEn: 'Furnace Room', floor: 'basement', symbol: 'O', doors: ['north', 'east'], description: '燃燒的鍋爐房', color: '#4A3A2A', icon: `${floor('#5A4A3A')}${doorN}${doorE}${symO}`, isOfficial: true, gallerySvg: '/gallery/rooms/20-furnace_room.svg' },
  { id: 'graveyard', name: '墓地', nameEn: 'Graveyard', floor: 'basement', symbol: null, doors: ['north', 'east'], description: '荒廢的墓地', color: '#3A4A3A', icon: `${floor('#4A5A4A')}${doorN}${doorE}`, isOfficial: true, gallerySvg: '/gallery/rooms/22-graveyard.svg' },
  ...
  { id: 'pentagram_chamber', name: '五芒星密室', nameEn: 'Pentagram Chamber', floor: 'basement', symbol: 'O', doors: ['north'], description: '畫著五芒星的密室', color: '#3A1A4A', icon: `${floor('#4A2A5A')}${doorN}${symO}`, isOfficial: true, gallerySvg: '/gallery/rooms/21-pentagram_chamber.svg' },
...
export const GROUND_ROOMS: Room[] = [
  { id: 'ballroom', name: '舞廳', nameEn: 'Ballroom', floor: 'ground', symbol: null, doors: ['north', 'south'], description: '華麗的舞廳', color: '#4A4A6A', icon: `${floor('#5A5A7A')}${doorN}${doorS}`, isOfficial: true, gallerySvg: '/gallery/rooms/06-ballroom.svg' },
  { id: 'chapel', name: '禮拜堂', nameEn: 'Chapel', floor: 'ground', symbol: 'O', doors: ['north'], description: '小型的禮拜堂', color: '#4A4A5A', icon: `${floor('#5A5A6A')}${doorN}${symO}`, isOfficial: true, gallerySvg: '/gallery/rooms/08-chapel.svg' },
  { id: 'dining_room', name: '餐廳', nameEn: 'Dining Room', floor: 'ground', symbol: 'I', doors: ['north', 'east'], description: '長餐桌的餐廳', color: '#5A4A3A', icon: `${floor('#6B5B4B')}${doorN}${doorE}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/07-dining_room.svg' },
  { id: 'entrance_hall', name: '入口大廳', nameEn: 'Entrance Hall', floor: 'ground', symbol: null, doors: ['north', 'south'], description: '房屋的入口', color: '#7B6354', icon: `${floor('#6B5344')}${doorN}${doorS}`, isOfficial: true, gallerySvg: '/gallery/rooms/02-entrance_hall.svg' },
  { id: 'foyer', name: '玄關', nameEn: 'Foyer', floor: 'ground', symbol: null, doors: ['north', 'south'], description: '房屋的玄關', color: '#8B7355', icon: `${floor('#6B5344')}${doorN}${doorS}`, isOfficial: true, gallerySvg: '/gallery/rooms/01-foyer.svg' },
  { id: 'garden', name: '花園', nameEn: 'Garden', floor: 'ground', symbol: 'E', doors: ['north', 'east'], description: '戶外花園', color: '#2F4F2F', icon: `${floor('#3A5A3A')}${doorN}${doorE}${symE}`, isOfficial: true, gallerySvg: '/gallery/rooms/09-garden.svg' },
  { id: 'gymnasium', name: '健身房', nameEn: 'Gymnasium', floor: 'ground', symbol: 'E', doors: ['north', 'east'], description: '室內健身房', color: '#5A6A5A', icon: `${floor('#6A7A6A')}${doorN}${doorE}${symE}`, isOfficial: true, gallerySvg: '/gallery/rooms/10-gymnasium.svg' },
  { id: 'kitchen', name: '廚房', nameEn: 'Kitchen', floor: 'ground', symbol: 'I', doors: ['north', 'east'], description: '家庭廚房', color: '#4A6741', icon: `${floor('#5A5A4A')}${doorN}${doorE}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/03-kitchen.svg' },
  { id: 'library', name: '圖書室', nameEn: 'Library', floor: 'ground', symbol: 'I', doors: ['north', 'east'], description: '滿是書的圖書室', color: '#5D4E37', icon: `${floor('#6B5B4B')}${doorN}${doorE}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/04-library.svg' },
  { id: 'patio', name: '庭院', nameEn: 'Patio', floor: 'ground', symbol: null, doors: ['north', 'east'], description: '戶外庭院', color: '#6A6A5A', icon: `${floor('#7A7A6A')}${doorN}${doorE}`, isOfficial: true, gallerySvg: '/gallery/rooms/11-patio.svg' },
  ...
  { id: 'tower', name: '塔樓', nameEn: 'Tower', floor: 'ground', symbol: null, doors: ['north'], description: '高聳的塔樓', color: '#556B8B', icon: `${floor('#5A6B7B')}${doorN}`, isOfficial: true, gallerySvg: '/gallery/rooms/12-tower.svg' },
];

// ==================== UPPER FLOOR (10 rooms) ====================
export const UPPER_ROOMS: Room[] = [
  { id: 'attic', name: '閣樓', nameEn: 'Attic', floor: 'upper', symbol: 'I', doors: ['north'], description: '屋頂的閣樓', color: '#4A4A3A', icon: `${floor('#5A5A4A')}${doorN}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/13-attic.svg' },
  { id: 'balcony', name: '陽台', nameEn: 'Balcony', floor: 'upper', symbol: null, doors: ['north', 'south'], description: '俯瞰的陽台', color: '#6A6A5A', icon: `${floor('#7A7A6A')}${doorN}${doorS}`, isOfficial: true, gallerySvg: '/gallery/rooms/14-balcony.svg' },
  { id: 'bedroom', name: '臥室', nameEn: 'Bedroom', floor: 'upper', symbol: 'O', doors: ['north'], description: '普通的臥室', color: '#6B4B4B', icon: `${floor('#5A3B3B')}${doorN}${symO}`, isOfficial: true, gallerySvg: '/gallery/rooms/05-bedroom.svg' },
  ...
  { id: 'master_bedroom', name: '主臥室', nameEn: 'Master Bedroom', floor: 'upper', symbol: 'O', doors: ['north', 'east'], description: '華麗的主臥室', color: '#7B4B4B', icon: `${floor('#6B4B4B')}${doorN}${doorE}${symO}`, isOfficial: true, gallerySvg: '/gallery/rooms/16-master_bedroom.svg' },
  { id: 'nursery', name: '嬰兒房', nameEn: 'Nursery', floor: 'upper', symbol: 'O', doors: ['north'], description: '嬰兒的房間', color: '#8B6B7B', icon: `${floor('#9B7B8B')}${doorN}${symO}`, isOfficial: true, gallerySvg: '/gallery/rooms/17-nursery.svg' },
