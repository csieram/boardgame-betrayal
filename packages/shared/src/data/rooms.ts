...
export const BASEMENT_ROOMS: Room[] = [
  ...
  { id: 'arsenal', name: '軍械庫', nameEn: 'Arsenal', floor: 'basement', symbol: 'I', doors: ['north', 'east'], description: '存放武器的房間', color: '#4A4A3A', icon: `${floor('#5A5A4A')}${doorN}${doorE}${symI}`, gallerySvg: '/gallery/rooms/arsenal.svg', isOfficial: true },
...
export const UPPER_ROOMS: Room[] = [
  ...
  { id: 'gallery', name: '畫廊', nameEn: 'Gallery', floor: 'upper', symbol: null, doors: ['north', 'east'], description: '展示畫作的畫廊', color: '#5A4A4A', icon: `${floor('#6A5A5A')}${doorN}${doorE}`, gallerySvg: '/gallery/rooms/gallery.svg', isOfficial: true },
