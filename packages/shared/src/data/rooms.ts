...
export const BASEMENT_ROOMS: Room[] = [
  { id: 'abandoned_room', name: '廢棄房間', nameEn: 'Abandoned Room', floor: 'basement', symbol: 'O', doors: ['north'], description: '被遺棄的房間', color: '#4A4A4A', icon: `${floor('#5A5A5A')}${doorN}${symO}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'arsenal', name: '軍械庫', nameEn: 'Arsenal', floor: 'basement', symbol: 'I', doors: ['north', 'east'], description: '存放武器的房間', color: '#4A4A3A', icon: `${floor('#5A5A4A')}${doorN}${doorE}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'bloody_room', name: '血跡房間', nameEn: 'Bloody Room', floor: 'basement', symbol: 'E', doors: ['north'], description: '滿是血跡的房間', color: '#5A3A3A', icon: `${floor('#6B4B4B')}${doorN}${symE}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'catacombs', name: '地下墓穴', nameEn: 'Catacombs', floor: 'basement', symbol: null, doors: ['north', 'east', 'south'], description: '古老的地下墓穴', color: '#3A3A3A', icon: `${floor('#4A4A4A')}${doorN}${doorE}${doorS}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'cavern', name: '洞穴', nameEn: 'Cavern', floor: 'basement', symbol: 'E', doors: ['north'], description: '天然形成的洞穴', color: '#2A2A2A', icon: `${floor('#3A3A3A')}${doorN}${symE}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'charred_room', name: '燒焦房間', nameEn: 'Charred Room', floor: 'basement', symbol: 'O', doors: ['north'], description: '被火燒過的房間', color: '#3A2A2A', icon: `${floor('#4A3A3A')}${doorN}${symO}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'chasm', name: '深淵', nameEn: 'Chasm', floor: 'basement', symbol: null, doors: ['north', 'east'], description: '地板裂開的深淵', color: '#1A1A1A', icon: `${floor('#0A0A0A')}${doorN}${doorE}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  ...
  { id: 'larder', name: '儲藏室', nameEn: 'Larder', floor: 'basement', symbol: 'I', doors: ['north'], description: '存放食物的儲藏室', color: '#4A4A3A', icon: `${floor('#5A5A4A')}${doorN}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'operating_lab', name: '手術實驗室', nameEn: 'Operating Laboratory', floor: 'basement', symbol: 'I', doors: ['north'], description: '進行手術的實驗室', color: '#4A5A4A', icon: `${floor('#5A6A6A')}${doorN}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  ...
  { id: 'research_lab', name: '研究實驗室', nameEn: 'Research Laboratory', floor: 'basement', symbol: 'I', doors: ['north'], description: '研究用的實驗室', color: '#4A5A5A', icon: `${floor('#5A6A6A')}${doorN}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'servants_quarters', name: '僕人房', nameEn: 'Servants Quarters', floor: 'basement', symbol: null, doors: ['north', 'east'], description: '僕人居住的地方', color: '#4A4A4A', icon: `${floor('#5A5A5A')}${doorN}${doorE}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'underground_lake', name: '地下湖', nameEn: 'Underground Lake', floor: 'basement', symbol: null, doors: ['north'], description: '地下的湖泊', color: '#2A3A4A', icon: `${floor('#3A4A5A')}${doorN}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'vault', name: '金庫', nameEn: 'Vault', floor: 'basement', symbol: 'I', doors: ['north'], description: '存放貴重物品的金庫', color: '#4A4A3A', icon: `${floor('#5A5A4A')}${doorN}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
];
...
export const GROUND_ROOMS: Room[] = [
  ...
  { id: 'storeroom', name: '儲物間', nameEn: 'Storeroom', floor: 'ground', symbol: 'I', doors: ['north'], description: '存放雜物的房間', color: '#4A4A4A', icon: `${floor('#5A5A5A')}${doorN}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
...
export const UPPER_ROOMS: Room[] = [
  ...
  { id: 'gallery', name: '畫廊', nameEn: 'Gallery', floor: 'upper', symbol: null, doors: ['north', 'east'], description: '展示畫作的畫廊', color: '#5A4A4A', icon: `${floor('#6A5A5A')}${doorN}${doorE}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'junk_room', name: '雜物間', nameEn: 'Junk Room', floor: 'upper', symbol: 'O', doors: ['north'], description: '堆滿雜物的房間', color: '#4A4A3A', icon: `${floor('#5A5A4A')}${doorN}${symO}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  ...
  { id: 'walkway', name: '走道', nameEn: 'Walkway', floor: 'upper', symbol: null, doors: ['north', 'south'], description: '連接的走道', color: '#5A5A5A', icon: `${floor('#6A6A6A')}${doorN}${doorS}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  // 額外的 Library, Tower, Research Lab 也可以在二樓
  { id: 'library_upper', name: '圖書室(二樓)', nameEn: 'Library', floor: 'upper', symbol: 'I', doors: ['north'], description: '二樓的圖書室', color: '#5D4E37', icon: `${floor('#6B5B4B')}${doorN}${symI}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'tower_upper', name: '塔樓(二樓)', nameEn: 'Tower', floor: 'upper', symbol: null, doors: ['north'], description: '二樓的塔樓', color: '#556B8B', icon: `${floor('#5A6B7B')}${doorN}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
];
...
export const MULTI_FLOOR_ROOMS: Room[] = [
  ...
  { id: 'stairs_from_basement', name: '地下室樓梯', nameEn: 'Stairs from Basement', floor: 'basement', symbol: null, doors: ['north'], description: '通往一樓', color: '#4A4A3A', icon: `${floor('#5A5A4A')}${doorN}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'stairs_from_ground', name: '一樓樓梯(下)', nameEn: 'Stairs from Ground', floor: 'ground', symbol: null, doors: ['north'], description: '通往地下室', color: '#6B5344', icon: `${floor('#5A4334')}${doorN}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
  { id: 'stairs_from_upper', name: '二樓樓梯', nameEn: 'Stairs from Upper', floor: 'upper', symbol: null, doors: ['north'], description: '通往一樓', color: '#5A4A4A', icon: `${floor('#4A3A3A')}${doorN}`, isOfficial: true, gallerySvg: '/gallery/rooms/abandoned_room.svg' },
